...
public class BeholdersVariations implements ModInitializer {
	...
	public static final Block SILICA_SAND = register("silica_sand", 
			new SandBlock(14866662, FabricBlockSettings.of(Material.AGGREGATE, MapColor.OFF_WHITE).strength(0.5F).sounds(BlockSoundGroup.SAND)), ItemGroup.BUILDING_BLOCKS);
	public static final Block SILICASTONE = register("silicastone", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.OFF_WHITE).requiresTool().strength(0.8F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block SMOOTH_SILICASTONE = register("smooth_silicastone", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.OFF_WHITE).requiresTool().strength(2.0F, 6.0F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block GEM_CUT_QUARTZ = register("gem_cut_quartz", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.OFF_WHITE).requiresTool().strength(5.0F, 6.0F)), ItemGroup.BUILDING_BLOCKS);
	
	public static final Block VITRIC_SANDSTONE = register("vitric_sandstone", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.PALE_YELLOW).requiresTool().strength(0.8F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block VITRIC_SANDSTONE_PILLAR = register("vitric_sandstone_pillar", 
			new PillarBlock(FabricBlockSettings.of(Material.STONE, MapColor.PALE_YELLOW).requiresTool().strength(0.8F)), ItemGroup.BUILDING_BLOCKS);
	public static final Block SMOOTH_VITRIC_SANDSTONE = register("smooth_vitric_sandstone", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.PALE_YELLOW).requiresTool().strength(2.0F, 6.0F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block VITRIC_RED_SANDSTONE = register("vitric_red_sandstone", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.ORANGE).requiresTool().strength(0.8F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block VITRIC_RED_SANDSTONE_PILLAR = register("vitric_red_sandstone_pillar", 
			new PillarBlock(FabricBlockSettings.of(Material.STONE, MapColor.ORANGE).requiresTool().strength(0.8F)), ItemGroup.BUILDING_BLOCKS);
	public static final Block SMOOTH_VITRIC_RED_SANDSTONE = register("smooth_vitric_red_sandstone", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.ORANGE).requiresTool().strength(2.0F, 6.0F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block SOULSANDSTONE = register("soulsandstone", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.BROWN).requiresTool().strength(0.8F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block SMOOTH_SOULSANDSTONE = register("smooth_soulsandstone", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.BROWN).requiresTool().strength(2.0F, 6.0F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block VITRIC_SOULSANDSTONE_PILLAR = register("vitric_soulsandstone_pillar", 
			new PillarBlock(FabricBlockSettings.of(Material.STONE, MapColor.BROWN).requiresTool().strength(0.8F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block PRISM_QUARTZ = register("prism_quartz", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.CYAN).requiresTool().strength(0.8F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block PRISM_QUARTZ_PILLAR = register("prism_quartz_pillar", 
			new PillarBlock(FabricBlockSettings.of(Material.STONE, MapColor.CYAN).requiresTool().strength(0.8F)), ItemGroup.BUILDING_BLOCKS);
	public static final Block SMOOTH_PRISM_QUARTZ = register("smooth_prism_quartz", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.CYAN).requiresTool().strength(2.0F, 6.0F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block GEM_CUT_PRISM_QUARTZ = register("gem_cut_prism_quartz", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.CYAN).requiresTool().strength(5.0F, 6.0F)), ItemGroup.BUILDING_BLOCKS);
	
	public static final Block PRISMARINE_SANDSTONE = register("prismarine_sandstone", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.DIAMOND_BLUE).requiresTool().strength(0.8F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block SMOOTH_PRISMARINE_SANDSTONE = register("smooth_prismarine_sandstone", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.DIAMOND_BLUE).requiresTool().strength(2.0F, 6.0F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block VITRIC_PRISMARINE_PILLAR = register("vitric_prismarine_pillar", 
			new PillarBlock(FabricBlockSettings.of(Material.STONE, MapColor.DIAMOND_BLUE).requiresTool().strength(0.8F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block GEM_CUT_VITRIC_PRISMARINE = register("gem_cut_vitric_prismarine", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.DIAMOND_BLUE).requiresTool().strength(5.0F, 6.0F)), ItemGroup.BUILDING_BLOCKS);
	
	public static final Block PRISMARINE_TILING = register("prismarine_tiling", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.DIAMOND_BLUE).requiresTool().strength(1.5F, 6.0F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block REFINED_OBSIDIAN = register("refined_obsidian", 
			new Block(FabricBlockSettings.of(BVMaterials.DECORATIVE_IMMOVABLE, MapColor.BLACK).requiresTool().breakByTool(FabricToolTags.PICKAXES, 3).strength(15.0F, 1200.0F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block REFINED_OBSIDIAN_PILLAR = register("refined_obsidian_pillar", 
			new PillarBlock(FabricBlockSettings.of(BVMaterials.DECORATIVE_IMMOVABLE, MapColor.BLACK).requiresTool().breakByTool(FabricToolTags.PICKAXES, 3).strength(15.0F, 1200.0F)), ItemGroup.BUILDING_BLOCKS);
	public static final Block SMOOTH_REFINED_OBSIDIAN = register("smooth_refined_obsidian", 
			new Block(FabricBlockSettings.of(BVMaterials.DECORATIVE_IMMOVABLE, MapColor.BLACK).requiresTool().breakByTool(FabricToolTags.PICKAXES, 3).strength(20.0F, 1200.0F)), ItemGroup.BUILDING_BLOCKS);
	...
	//		new Block(FabricBlockSettings.of(BVMaterials.DECORATIVE_IMMOVABLE, MapColor.DIAMOND_BLUE).requiresTool().strength(0.8F)), ItemGroup.BUILDING_BLOCKS);
	
	public static final Block JADE_BLOCK = register("jade_block", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.GREEN).requiresTool().strength(0.8F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block JADE_PILLAR = register("jade_pillar", 
			new PillarBlock(FabricBlockSettings.of(Material.STONE, MapColor.GREEN).requiresTool().strength(0.8F)), ItemGroup.BUILDING_BLOCKS);
	public static final Block SMOOTH_JADE = register("smooth_jade", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.GREEN).requiresTool().strength(2.0F, 6.0F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block GEM_CUT_JADE = register("gem_cut_jade", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.GREEN).requiresTool().strength(5.0F, 6.0F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block GEM_CUT_AMBER = register("gem_cut_amber", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.ORANGE).requiresTool().strength(5.0F, 6.0F)), ItemGroup.BUILDING_BLOCKS);
	
	public static final Block EMERALD_QUARTZ = register("emerald_quartz", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.EMERALD_GREEN).requiresTool().strength(0.8F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block EMERALD_QUARTZ_PILLAR = register("emerald_quartz_pillar", 
			new PillarBlock(FabricBlockSettings.of(Material.STONE, MapColor.EMERALD_GREEN).requiresTool().strength(0.8F)), ItemGroup.BUILDING_BLOCKS);
	public static final Block SMOOTH_EMERALD_QUARTZ = register("smooth_emerald_quartz", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.EMERALD_GREEN).requiresTool().strength(2.0F, 6.0F)), ItemGroup.BUILDING_BLOCKS);
	...
	//		new Block(FabricBlockSettings.of(Material.METAL, MapColor.EMERALD_GREEN).requiresTool().strength(3.0F, 6.0F).sounds(BlockSoundGroup.METAL)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block GEM_CUT_DIAMOND_BLOCK = register("gem_cut_diamond_block", 
			new Block(FabricBlockSettings.of(Material.METAL, MapColor.DIAMOND_BLUE).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL)), ItemGroup.BUILDING_BLOCKS);
	...
	*/
	...
	public static final Block VITRIC_REDSTONE = register("vitric_redstone", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.BRIGHT_RED).requiresTool().strength(0.8F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block VITRIC_REDSTONE_PILLAR = register("vitric_redstone_pillar", 
			new PillarBlock(FabricBlockSettings.of(Material.STONE, MapColor.BRIGHT_RED).requiresTool().strength(0.8F)), ItemGroup.BUILDING_BLOCKS);
	public static final Block SMOOTH_VITRIC_REDSTONE = register("smooth_vitric_redstone", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.BRIGHT_RED).requiresTool().strength(2.0F, 6.0F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block GEM_CUT_REDSTONE_BLOCK = register("gem_cut_redstone_block", 
			new RedstoneBlock(FabricBlockSettings.of(Material.METAL, MapColor.BRIGHT_RED).requiresTool().strength(5.0F, 6.0F).sounds(BlockSoundGroup.METAL)), ItemGroup.BUILDING_BLOCKS);
	public static final Block COMPACT_REDSTONE_BLOCK = register("compact_redstone_block", 
			new RedstoneBlock(FabricBlockSettings.of(Material.METAL, MapColor.BRIGHT_RED).requiresTool().strength(3.0F, 6.0F).sounds(BlockSoundGroup.METAL)), ItemGroup.REDSTONE);
	
	public static final Block BLACK_SAND = register("black_sand", 
			new SandBlock(14866662, FabricBlockSettings.of(Material.AGGREGATE, MapColor.BLACK).strength(0.5F).sounds(BlockSoundGroup.SAND)), ItemGroup.BUILDING_BLOCKS);
	public static final Block BLACK_SANDSTONE = register("black_sandstone", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.BLACK).requiresTool().strength(0.8F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block SMOOTH_BLACK_SANDSTONE = register("smooth_black_sandstone", 
			new Block(FabricBlockSettings.of(Material.STONE, MapColor.BLACK).requiresTool().strength(2.0F, 6.0F)), ItemGroup.BUILDING_BLOCKS);
	...
	public static final Block VITRIC_BLACK_SANDSTONE_PILLAR = register("vitric_black_sandstone_pillar", 
			new PillarBlock(FabricBlockSettings.of(Material.STONE, MapColor.BLACK).requiresTool().strength(0.8F)), ItemGroup.BUILDING_BLOCKS);
